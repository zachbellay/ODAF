...
int NewPing::ping(unsigned int max_cm_distance) {
...
long NewPing::ping_cm(unsigned int max_cm_distance) {
	int echoTime = NewPing::ping(max_cm_distance); // Calls the ping method and returns with the ping echo distance in uS.
...
long NewPing::ping_in(unsigned int max_cm_distance) {
...
long NewPing::ping_median(uint8_t it, unsigned int max_cm_distance) {
