...
// ---------------------------------------------------------------------------
	...
	class NewPing {
		public:
			...
			int ping(unsigned int max_cm_distance = 0);
			long ping_cm(unsigned int max_cm_distance = 0);
			long ping_in(unsigned int max_cm_distance = 0);
			long ping_median(uint8_t it = 5, unsigned int max_cm_distance = 0);
